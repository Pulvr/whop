...
public class Person implements Serializable{
	 ...
	 * Nat�rlich sollte im normalfall das Passwort nicht mit ausgegeben werden, da
	 * wir aber sonst den wert nicht erkennen k�nnen haben wir ihn uns mit ausgeben lassen
	 */
	...
	/**
	 * methode zum hinzuf�gen von Waren in den Warenkorb
	 * @param w
	 * @param menge
	 */
