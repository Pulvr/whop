...
public class LagerVerwaltung {
	...
	/**
	 * Methode zum l�schen einer Person
	 * 
	 * @param einePerson
	...
	/**
	 * Methode die Waren aus dem Korb entfernen kann, sollte die angegebene Zahl die Anzahl der Waren im Korb �bersteigen
	...
	/**
	 * Gibt den Warenlog f�r eine Ware zur�ck mit einer Angabe wie weit der Log zur�ck liegen soll
	 * @param bezeichnung Log f�r welche Ware?
	 * @param daysInPast wieviele Tage soll der Log zur�ck liegen
	 * @return den WarenLog
	 * @throws IOException
	...
	/**
	 * Gibt die Rechnung die beim Kauf entsteht zur�ck
	 * @return
	 */
	...
	/**
	 * Hiermit l�sst sich die Rechnung f�r einen Kauf setzen
